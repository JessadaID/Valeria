  ...
  <div class="max-w-md mx-auto bg-white rounded-lg shadow-md p-6">
    <div class="mb-6 text-center">
      ...
      <p class="text-gray-700">
        จำนวนเงินที่ต้องชำระ: <span class="font-bold text-green-600"
          >{amount ? amount.toFixed(2) : "N/A"} บาท</span
        >
      </p>
      <p class="text-gray-600 text-sm">
        หมายเลขคำสั่งซื้อ: {orderId || "ไม่มี"}
      </p>
    ...
    {#if qrCodeDataUrl}
      <div class="flex justify-center mb-6">
        <img
          ...
          class="w-64 h-64 border border-gray-300 p-2 rounded-md"
        />
      </div>
      ...
      <div class="text-center mb-6">
        ...
        <p class="text-gray-600 text-sm">
          ใช้แอปพลิเคชันธนาคารของคุณเพื่อสแกน QR Code ด้านบน
        </p>
      </div>
    {:else}
