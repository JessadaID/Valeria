    ...
    >
        <div class="relative overflow-hidden">
            {#if media.type === "video"}
                ...
                />
                <div
                    class="absolute inset-0 bg-black/30 group-hover:bg-black/40 transition-all duration-300 flex items-center justify-center opacity-100 group-hover:opacity-100"
                >
                    <svg
                ...
                <div
                    class="absolute bottom-2 right-2 bg-black bg-opacity-70 text-white text-xs px-2 py-1 rounded-md"
                >
            ...
            {:else}
                <div class="relative">
                    ...
                    />
                    <div
                        class="absolute inset-0 bg-black/0 group-hover:bg-black/20 transition-all duration-300 flex items-center justify-center opacity-0 group-hover:opacity-100 pointer-events-none"
                    ></div>
                    <a
                        href={media.fullUrl}
